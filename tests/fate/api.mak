...
FATE_API_LIBAVCODEC-$(CONFIG_H264_METADATA_BSF) += fate-api-h264-mvc
fate-api-h264-mvc: $(APITESTSDIR)/api-h264-mvc-test$(EXESUF)
fate-api-h264-mvc: CMD = run $(APITESTSDIR)/api-h264-mvc-test$(EXESUF) $(TARGET_PATH)/tests/data/h264-mvc-subset-sps.h264
fate-api-h264-mvc: CMP = null
